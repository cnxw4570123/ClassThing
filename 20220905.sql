...
/* NOT NULL : 특정 컬럼에 NULL 값이 입력되지 않도록 방지 */
...
-- ORA-02296: (JGM_DBA.) 사용으로 설정 불가 - 널 값이 발견되었습니다.
-- 해결방안 ㅣ 1. PHNAME 컬럼의 NULL값을 수정
...
-- ORA-01400: NULL을 ("JGM_DBA"."PHONEBOOK"."PHNAME") 안에 삽입할 수 없습니다

DESC PHONEBOOK;

/* PHONEBOOK테이블의 PHNAME 컬럼에 NULL 허용 */
ALTER TABLE PHONEBOOK
MODIFY PHNAME NULL;
...
/* PRIMARY KEY(기본키) : UNIQUE + NOT NULL
    - 테이블에서 특정한 데이터를 찾기 위함이다.

*/

CREATE TABLE MEMBER_TEST(
    MID NVARCHAR2(20),   -- 중복X, NULL X.
    MPW NVARCHAR2(20),   -- NULL X.
    MNAME NVARCHAR2(5),  -- NULL X.
    MGENDER NUMBER(1),   -- 성별(1, 3 : 남, 2, 4 : 여)
    MBIRTH DATE,
    MEMAIL NVARCHAR2(50) -- 중복X, NULL X;
);

INSERT INTO MEMBER_TEST(MID, MPW, MNAME, MGENDER, MBIRTH)
VALUES('YYYY', '1111', '정균민', 1, TO_DATE('1996-08-12'));

INSERT INTO MEMBER_TEST(MID, MPW, MNAME, MGENDER, MBIRTH)
VALUES('YYYX', '1111', '김양호', 1, TO_DATE('1996-08-12'));

INSERT INTO MEMBER_TEST(MID, MPW, MNAME, MGENDER, MBIRTH)
VALUES('YYYZ', '1111', '심상준', 1, TO_DATE('1996-08-12'));
...
UPDATE MEMBER_TEST
SET MEMAIL = 'cnxw4@naver.com'
WHERE MID ='YYYY';


CREATE TABLE BOOLEAN_TEST(
    bool_test NUMBER(1) CONSTRAINT ck_bool_test CHECK(BOOL_TEST = 0 OR BOOL_TEST = 1)
);

INSERT INTO BOOLEAN_TEST VALUES(1);
INSERT INTO BOOLEAN_TEST VALUES(0);

INSERT INTO BOOLEAN_TEST VALUES(2);
