...
//	private int num = 0;
	...
	public void showMenu() {
		...
		while(run) {
			System.out.println("===================================================");
			System.out.println(" [1]상품등록 | [2]상품검색 | [3]상품수정 | [4]전체상품목록 |[5]종료");
			System.out.println("===================================================");
	...
	public void checkProdType() {
		...
		if(idx != -1) {
			...
			for(int i = 0; i < prodList.size(); i++) {
				if(searcType.equals(prodList.get(i).getProdType())) {
					System.out.print("[상품이름]"+prodList.get(i).getProdName()+ " ");
					System.out.print("[상품가격]"+prodList.get(i).getProdPrice() + "원 ");
					System.out.print("[상품수량]"+prodList.get(i).getProdVol()+ "개 ");
					System.out.print("[상품종류]"+prodList.get(i).getProdType());
					System.out.println();
				}
			}
		} else {
	...
	public void modifyProd(int idx, int com) {
		...
		if(com == 1) {
			...
			System.out.println("상품의 재고가 변경(" + befMp + ">>" + search.getProdPrice() + ") 되었습니다.");
		} else if(com == 2) {
			...
			System.out.println("상품의 재고가 변경(" + befMv + ">>" + search.getProdVol() + ") 되었습니다.");
