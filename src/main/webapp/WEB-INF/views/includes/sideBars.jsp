            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${pageContext.request.contextPath }/KakaoPay_go">카카오페이</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath }/Tago_Test">타고테스트</a>
                    </div>
                </div>
            </li>
